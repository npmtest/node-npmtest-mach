...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mach/node_modules/mach/modules/middleware/token.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mach/node_modules/mach/modules/middleware/token.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mach/node_modules/mach/modules/middleware/</a> &#187; token.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function verifyToken(app, options) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var paramName = options.paramName || '_token';</span>
<span class="cstat-no" title="statement not covered" >  var sessionKey = options.sessionKey || '_token';</span>
<span class="cstat-no" title="statement not covered" >  var byteLength = options.byteLength || 32;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var session = conn.session, params = conn.params;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      conn.onError(new Error('No session! Use mach.session in front of mach.token'));</span>
    } else <span class="cstat-no" title="statement not covered" >if (!params) {</span>
...
<span class="cstat-no" title="statement not covered" >      var token = session[sessionKey];</span>
&nbsp;
      // Create a new session token if needed.
<span class="cstat-no" title="statement not covered" >      if (!token)</span>
<span class="cstat-no" title="statement not covered" >        token = session[sessionKey] = makeToken(byteLength);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (params[paramName] &amp;&amp; params[paramName] === token)</span>
...
<span class="cstat-no" title="statement not covered" >    if (SAFE_METHODS[conn.method] === true)</span>
<span class="cstat-no" title="statement not covered" >      return conn.call(app);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    conn.text(403, 'Forbidden');</span>
  };
}
&nbsp;
