...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mach/node_modules/mach/modules/utils/makeHash.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mach/node_modules/mach/modules/utils/makeHash.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mach/node_modules/mach/modules/utils/</a> &#187; makeHash.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function makeHash(string) {</span>
<span class="cstat-no" title="statement not covered" >  return crypto.createHash('sha1').update(string).digest('hex');</span>
}
&nbsp;
