...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mach/node_modules/mach/modules/utils/generateETag.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mach/node_modules/mach/modules/utils/generateETag.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mach/node_modules/mach/modules/utils/</a> &#187; generateETag.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function generateETag(path) {</span>
...
<span class="cstat-no" title="statement not covered" >    fs.readFile(path, <span class="fstat-no" title="function not covered" >function (error, data) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        resolve('"' + crypto.createHash('md5').update(data).digest('hex') + '"');</span>
      }
    });
  });
}
