...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mach/node_modules/mach/lib/Connection.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mach/node_modules/mach/lib/Connection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mach/node_modules/mach/lib/</a> &#187; Connection.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (scheme.toLowerCase() === "basic") <span class="cstat-no" title="statement not covered" >return decodeBase64(parts[1]);</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          if (value.headers != null) <span class="cstat-no" title="statement not covered" >conn.response.headers = value.headers;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (value.content != null) <span class="cstat-no" title="statement not covered" >conn.response.content = value.content;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (value.status != null) <span class="cstat-no" title="statement not covered" >conn.status = value.status;</span></span>
        }
      });
    } catch (error) {
